...
class RepoRequest(Base):
    ...
    visibility = Column(String(50), default="private", nullable=False)       # "private", "internal", "public"
    status = Column(String(50), default="pending", nullable=False, index=True)  # "pending", "provisioning", "ready", "failed"
